...
categories: ai
tags: [fooocus, defussion]
---
我們知道使用ai生成圖片，依照這幾年ai的發展歷程，有三種方式可以生成圖片。(1)GAN 生成對抗網路、(2)Diffusion Models、(3)LLM生成圖片。
今天我們要分享的Fooocus，是屬於第二種。

首先，你可以先到github，將[fooocus的colab程式](https://github.com/lllyasviel/Fooocus)複製一份到自己的GoogleDrive跑。
